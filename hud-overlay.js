...
/* ============================================================
      ...
      /* 模块 6: AI 助手 (红色进入；红色与图标同色，对比度 4.78:1 过 AA) */
      .yami-home-module-icon-box.red {
        color: #ff5252 !important;
      }
      .yami-home-module-badge.red {
        background: #45151b !important;
        border: 1px solid #8c2634 !important;
        color: #ff5252 !important;
        font-weight: 600 !important;
      }
      .yami-home-module-badge.red:hover {
        background: #5c1c24 !important;
        color: #ffffff !important;
      }
      ...
      /* ============ AI 助手 (Industrial Dark Aesthetics) ============ */
      .yami-ai-page {
      ...
      .yami-ai-status.ready .yami-ai-status-text { color: #34d399 !important; }

      .yami-ai-status.working .yami-ai-status-pulse {
        background: #3b82f6 !important;
        box-shadow: 0 0 8px rgba(59, 130, 246, 0.8) !important;
        animation: yami-ai-glow 1.4s infinite !important;
      }
      .yami-ai-status.working .yami-ai-status-text { color: #60a5fa !important; }

      .yami-ai-status.waiting .yami-ai-status-pulse {
        background: #f59e0b !important;
        box-shadow: 0 0 6px rgba(245, 158, 11, 0.6) !important;
      }
      .yami-ai-status.waiting .yami-ai-status-text { color: #fbbf24 !important; }

      .yami-ai-status.error .yami-ai-status-pulse {
        background: #ef4444 !important;
        box-shadow: 0 0 6px rgba(239, 68, 68, 0.6) !important;
      }
      .yami-ai-status.error .yami-ai-status-text { color: #f87171 !important; }

      @keyframes yami-ai-glow {
      ...
      .yami-ai-primary svg,
      .yami-ai-secondary svg {
        flex: 0 0 auto !important;
        display: block !important;
      }
      .yami-ai-tool-btn:hover,
      .yami-ai-secondary:hover {
      ...
      .yami-ai-secondary:focus-visible,
      .yami-ai-page input:focus-visible,
      .yami-ai-page textarea:focus-visible,
      .yami-ai-page select:focus-visible {
      ...
      .yami-ai-primary:hover {
        background: #3b82f6 !important;
        border-color: #2563eb !important;
        box-shadow: 0 3px 8px rgba(37, 99, 235, 0.4) !important;
        transform: translateY(-0.5px) !important;
      }
      .yami-ai-primary:active {
        transform: translateY(0.5px) !important;
      }
      .yami-ai-primary.disabled {
        opacity: 0.5 !important;
        cursor: default !important;
        transform: none !important;
      ...
      .yami-ai-settings-header,
      .yami-ai-settings-head {
        display: flex !important;
        align-items: center !important;
        justify-content: space-between !important;
      ...
      .yami-ai-settings-title,
      .yami-ai-settings-head span {
        font-size: 13px !important;
        font-weight: 600 !important;
        color: #e5e7eb !important;
      }
      .yami-ai-settings-close {
        display: inline-flex !important;
        align-items: center !important;
        justify-content: center !important;
      ...
      .yami-ai-settings-close:hover {
        background: rgba(239, 68, 68, 0.18) !important;
        border-color: rgba(239, 68, 68, 0.45) !important;
        color: #fca5a5 !important;
      }
      .yami-ai-settings-close svg {
        display: block !important;
      }
      ...
      .yami-ai-settings select {
        ...
        color: #f3f4f6 !important;
        font: 400 12px/1.5 ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace !important;
        padding: 6px 9px !important;
        transition: border-color 0.15s, box-shadow 0.15s !important;
      }
      .yami-ai-settings input:focus,
      .yami-ai-settings select:focus {
        border-color: #3b82f6 !important;
        box-shadow: 0 0 0 2px rgba(59, 130, 246, 0.2) !important;
      }
      .yami-ai-settings select option {
        background: #18191e !important;
        color: #e5e7eb !important;
      }
      .yami-ai-check {
      ...
      .yami-ai-settings .yami-ai-primary {
      ...
      .yami-ai-model-row input,
      .yami-ai-model-row select { flex: 1 1 auto !important; min-width: 0 !important; }
      .yami-ai-model-row .yami-ai-secondary { flex: 0 0 auto !important; height: 28px !important; }

      /* 消息列表流 (Messages Stream) */
      .yami-ai-messages {
      ...
      .yami-ai-jump:hover {
        background: #24304c !important;
        border-color: #60a5fa !important;
        color: #ffffff !important;
        transform: translateY(-1px) !important;
      }

      /* 对话消息气泡 (Message Bubbles) */
      .yami-ai-message {
      ...
      .yami-ai-message.user {
        align-self: flex-end !important;
        border-color: rgba(59, 130, 246, 0.35) !important;
        background: linear-gradient(135deg, #1e3a5f 0%, #152744 100%) !important;
        color: #f0f6fc !important;
        border-radius: 6px 6px 2px 6px !important;
        box-shadow: 0 3px 10px rgba(0, 0, 0, 0.25) !important;
      }
      .yami-ai-message.system {
        color: #9ca3af !important;
        background: #15161a !important;
        border-color: rgba(255, 255, 255, 0.05) !important;
      }
      .yami-ai-message.error {
        border-color: rgba(239, 68, 68, 0.3) !important;
        background: #251818 !important;
        color: #fca5a5 !important;
      }
      ...
      .yami-ai-notice {
        ...
        padding: 4px 8px !important;
        border-inline-start: 2px solid rgba(255, 255, 255, 0.15) !important;
        color: #9ca3af !important;
        font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace !important;
        font-size: 12px !important;
        line-height: 1.5 !important;
      ...
      .yami-ai-notice.ok { border-inline-start-color: #10b981 !important; color: #6ee7b7 !important; }
      .yami-ai-notice.bad { border-inline-start-color: #ef4444 !important; color: #fca5a5 !important; }
      .yami-ai-notice.wait { border-inline-start-color: #f59e0b !important; color: #fcd34d !important; }
      ...
      .yami-ai-process-title {
        color: #cbd5e1 !important;
        font-size: 12px !important;
        font-weight: 600 !important;
      }
      .yami-ai-process-meta {
        color: #64748b !important;
        font-size: 11px !important;
        font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace !important;
      }
      .yami-ai-process-toggle {
        margin-inline-start: auto !important;
        color: #64748b !important;
        font-size: 12px !important;
        line-height: 1 !important;
      ...
      .yami-ai-process-head:hover .yami-ai-process-toggle { color: #e2e8f0 !important; }
      ...
      .yami-ai-thinking-title {
        color: #a5b4fc !important;
        font-size: 12px !important;
        font-weight: 600 !important;
      }
      .yami-ai-thinking-meta {
        color: #64748b !important;
        font-size: 11px !important;
        font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace !important;
      }
      ...
      .yami-ai-thinking-toggle:hover { color: #cbd5e1 !important; }
      ...
      /* 一体化输入工作舱与布局 (Input Island Workstation) */
      .yami-ai-compose {
        display: flex !important;
        flex-direction: column !important;
        gap: 6px !important;
      ...
      .yami-ai-input-wrap {
        ...
        padding: 6px 10px !important;
        box-shadow: 0 2px 8px rgba(0, 0, 0, 0.2) !important;
        transition: border-color 0.2s cubic-bezier(0.4, 0, 0.2, 1), box-shadow 0.2s cubic-bezier(0.4, 0, 0.2, 1), background-color 0.2s cubic-bezier(0.4, 0, 0.2, 1) !important;
      }
      .yami-ai-input-wrap:focus-within {
        border-color: rgba(59, 130, 246, 0.5) !important;
        background: #191b22 !important;
        box-shadow: 0 0 0 1px rgba(59, 130, 246, 0.25), 0 3px 12px rgba(0, 0, 0, 0.35) !important;
      }

      /* @ 引用工程文件的候选浮层（G-3）：浮在输入框上方，不挤动布局 */
      .yami-ai-mention {
        position: absolute !important;
        left: 0 !important;
        right: 0 !important;
      ...
      /* 必须显式关掉：上面的 display: flex !important 会盖掉 hidden 属性的默认 display:none */
      .yami-ai-mention[hidden] {
        display: none !important;
      }
      .yami-ai-mention-item {
        display: flex !important;
      ...
      .yami-ai-mention-item.active {
        background: rgba(59, 130, 246, 0.22) !important;
      }
      .yami-ai-mention-name {
      ...
      #yami-ai-input {
        ...
        background: transparent !important;
        color: #f3f4f6 !important;
        font: 400 13px/1.55 -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif !important;
        padding: 0 !important;
        resize: none !important;
      }

      /* 发送与停止键：与输入框并排在右侧，等高拉伸，纯文字展示 */
      #yami-ai-send {
      ...
      .yami-ai-capsule-icon {
        display: inline-flex !important;
        align-items: center !important;
        justify-content: center !important;
        color: #38bdf8 !important;
      }
      .yami-ai-thinking-capsule .yami-ai-capsule-icon {
      ...
      .yami-ai-capsule-btn:hover,
      .yami-ai-fetch-btn:hover {
        color: #38bdf8 !important;
        background: rgba(56, 189, 248, 0.15) !important;
        border-color: rgba(56, 189, 248, 0.3) !important;
      }
      .yami-ai-capsule-btn.busy,
      .yami-ai-fetch-btn.busy {
        animation: yami-spin 0.8s linear infinite !important;
        color: #38bdf8 !important;
      }
      @keyframes yami-spin {
      ...
      .yami-ai-undo-tip { color: #9ca3af !important; font-size: 12px !important; line-height: 1.5 !important; }
      .yami-ai-undo-item {
        display: flex !important;
        align-items: center !important;
        justify-content: space-between !important;
      ...
      .yami-ai-history-empty { color: #64748b !important; font-size: 12px !important; line-height: 1.5 !important; }
      ...
      .yami-ai-history-item:hover {
        border-color: rgba(255, 255, 255, 0.15) !important;
        background: #252730 !important;
      }
      .yami-ai-history-item:active { transform: scale(0.99) !important; }
      .yami-ai-history-item.current {
        border-color: rgba(59, 130, 246, 0.4) !important;
        background: rgba(59, 130, 246, 0.08) !important;
      }
      .yami-ai-history-title { color: #e5e7eb !important; font-size: 13px !important; font-weight: 500 !important; }
      .yami-ai-history-meta {
        color: #64748b !important;
        font-size: 11px !important;
        font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace !important;
      }
      ...
      .yami-ai-approval.show { display: block !important; }
      .yami-ai-approval-title {
        color: #fbbf24 !important;
        font-size: 13px !important;
        font-weight: 600 !important;
      }
      .yami-ai-approval pre {
      ...
      .yami-ai-approval.danger .yami-ai-approval-title { color: #f87171 !important; }
      .yami-ai-approval-stat {
        display: none !important;
        margin-top: 4px !important;
        color: #9ca3af !important;
        font: 400 11px/1.4 ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace !important;
      }
      ...
      .yami-ai-diff-line.add { color: #6ee7b7 !important; background: rgba(16, 185, 129, 0.12) !important; }
      .yami-ai-diff-line.del { color: #fca5a5 !important; background: rgba(239, 68, 68, 0.12) !important; }
      .yami-ai-diff-line.hunk { color: #60a5fa !important; }
      .yami-ai-approval-actions { display: flex !important; justify-content: flex-end !important; gap: 8px !important; margin-top: 8px !important; }
      ...
      .yami-ai-tool-dot.run { background: #3b82f6 !important; animation: yami-ai-glow 1.2s infinite !important; }
      .yami-ai-tool-dot.ok { background: #10b981 !important; }
      .yami-ai-tool-dot.bad { background: #ef4444 !important; }
      .yami-ai-tool-dot.wait { background: #f59e0b !important; }
      .yami-ai-tool-title { color: #d1d5db !important; font-weight: 600 !important; flex: 0 0 auto !important; }
      .yami-ai-tool-target {
        color: #64748b !important;
        font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace !important;
        font-size: 11px !important;
      ...
      .yami-ai-tool-target.clickable:hover { color: #38bdf8 !important; }
      .yami-ai-tool-chips {
        margin-inline-start: auto !important;
        color: #64748b !important;
        font-size: 11px !important;
      ...
      .yami-ai-tool-head:hover .yami-ai-tool-toggle { color: #e2e8f0 !important; }
      .yami-ai-tool-body {
        display: none !important;
        padding: 6px 10px !important;
        color: #94a3b8 !important;
      ...
      .yami-ai-tool-spill { color: #38bdf8 !important; cursor: pointer !important; text-decoration: underline !important; margin-top: 4px !important; }
      ...
      .yami-ai-system-title { color: #94a3b8 !important; font-size: 12px !important; font-weight: 600 !important; }
      .yami-ai-system-meta { color: #64748b !important; font-size: 11px !important; font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace !important; }
      .yami-ai-system-toggle { margin-inline-start: auto !important; color: #64748b !important; font-size: 11px !important; }
      .yami-ai-system-body {
        display: none !important;
        margin-top: 4px !important;
      ...
      .yami-ai-steer.ok { border-inline-start-color: #10b981 !important; background: #121f17 !important; color: #6ee7b7 !important; }
      ...
      .yami-ai-queue-head { color: #64748b !important; font-size: 11px !important; }
      .yami-ai-queue-item { display: flex !important; align-items: center !important; gap: 6px !important; background: #1e1f25 !important; border-radius: 4px !important; padding: 3px 8px !important; }
      .yami-ai-queue-text { color: #cbd5e1 !important; font-size: 11px !important; overflow: hidden !important; text-overflow: ellipsis !important; white-space: nowrap !important; min-width: 0 !important; flex: 1 1 auto !important; }
      .yami-ai-queue-del { color: #64748b !important; cursor: pointer !important; font-size: 13px !important; line-height: 1 !important; flex: 0 0 auto !important; }
      .yami-ai-queue-del:hover { color: #ef4444 !important; }
      ...
      .yami-ai-rail-tick:hover { background: #64748b !important; width: 9px !important; }
      .yami-ai-rail-tick.active { background: #3b82f6 !important; width: 9px !important; }
      ...
      .yami-ai-mention::-webkit-scrollbar-track,
      ...
      .yami-ai-mention::-webkit-scrollbar-thumb,
      ...
      .yami-ai-mention::-webkit-scrollbar-thumb:hover,
    ...
    dock.innerHTML = `
      ...
      <div class="yami-perf-dock-footer">
        <div style="color: #808080; display: flex; align-items: center; gap: 8px;">
          <span id="yami-version-badge" style="color: #0080c0; cursor: pointer; text-decoration: underline;" title="点击检查 GitHub 最新版本">v1.11.6 (检查更新)</span>
...
// (escapeHtml 已统一提升为模块顶级公共转义函数)
    ...
    function refreshVersionBadge() {
      ...
      const probe = window.__YAMI_PERF_PROBE__;
      const cur = (probe && probe.version) ? probe.version : '1.11.6';
    ...
    if (versionBadge) {
      versionBadge.addEventListener('click', async function(e) {
        ...
        if (res.hasUpdate) {
          ...
          showToast('当前已是最新版本 (v' + (probe.version || '1.11.6') + ')');
          refreshVersionBadge();
        }
      });
    }
