...
/* ============================================================
      ...
      .yami-ai-status.ready { color: #4ade80 !important; }
      .yami-ai-status.working { color: #60a5fa !important; }
      .yami-ai-status.waiting { color: #fbbf24 !important; }
      .yami-ai-status.error { color: #ff8888 !important; }
      .yami-ai-tool-btn,
      .yami-ai-primary,
      .yami-ai-secondary {
        position: static !important;
        ...
        cursor: pointer !important;
        user-select: none !important;
        transition: background-color 0.12s, border-color 0.12s, scale 0.12s !important;
      }
      .yami-ai-primary {
        border-color: #0864a8 !important;
        background: #0864a8 !important;
        color: #ffffff !important;
      }
      .yami-ai-secondary { background: #242424 !important; }
      .yami-ai-tool-btn:hover,
      .yami-ai-secondary:hover { background: #3d3d3d !important; }
      .yami-ai-primary:hover { background: #0874c0 !important; }
      ...
      .yami-ai-secondary:active { scale: 0.96 !important; }
      ...
      .yami-ai-compose textarea {
        ...
        background: #18191a !important;
        color: #e8e8e8 !important;
        font: 400 13px/1.5 Inter, "Microsoft YaHei UI", sans-serif !important;
        padding: 7px 8px !important;
      ...
      /* 收起后的过程行：只留一行控制条，别再占正文的地盘 */
      .yami-ai-process.collapsed {
        background: #1a1a1e !important;
      }
      /* 每轮用量行：贴在轮次末尾的一行小字，记账不全时根本不会出现 */
      .yami-ai-turn-usage {
      ...
      .yami-ai-approval-title { color: #ffd37a !important; font-size: 13px !important; font-weight: 600 !important; }
    ...
    dock.innerHTML = `
      ...
      <div class="yami-perf-dock-footer">
        <div style="color: #808080; display: flex; align-items: center; gap: 8px;">
          <span id="yami-version-badge" style="color: #0080c0; cursor: pointer; text-decoration: underline;" title="点击检查 GitHub 最新版本">v1.5.1 (检查更新)</span>
...
// (escapeHtml 已统一提升为模块顶级公共转义函数)
    ...
    function refreshVersionBadge() {
      ...
      const probe = window.__YAMI_PERF_PROBE__;
      const cur = (probe && probe.version) ? probe.version : '1.5.1';
    ...
    if (versionBadge) {
      versionBadge.addEventListener('click', async function(e) {
        ...
        if (res.hasUpdate) {
          ...
          showToast('当前已是最新版本 (v' + (probe.version || '1.5.1') + ')');
          refreshVersionBadge();
        }
      });
    }
